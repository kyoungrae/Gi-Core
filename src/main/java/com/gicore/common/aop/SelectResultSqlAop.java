package com.gicore.common.aop;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.node.ObjectNode;
import com.gicore.common.annotation.*;
import com.gicore.common.enumlist.AopDateToStringTransformFieldNameList;
import com.gicore.common.enumlist.AopIntegerToStringSetCommaFieldNameList;
import com.gicore.common.enumlist.AopSetDataValueTransformFieldNameList;
...
public class SelectResultSqlAop {
    ...
    @Around("execution(* com.gicore..*Service.*(..)) && !execution(* com.gicore.common.common.file..*.*(..)) && !execution(* com.gicore.common.common.api..*.*(..)) && !execution(* com.gicore.common.common.mail..*.*(..))&& !execution(* com.gicore.common.config..*.*(..))" )
